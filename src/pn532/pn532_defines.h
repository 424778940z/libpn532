...
typedef enum
{
    PN532_SFR_PCON = 0xFF87,
    PN532_SFR_RWL = 0xFF9A,
    PN532_SFR_TWL = 0xFF9B,
    PN532_SFR_FIFOFS = 0xFF9C,
    PN532_SFR_FIFOFF = 0xFF9D,
    PN532_SFR_SFF = 0xFF9E,
    PN532_SFR_FIT = 0xFF9F,
    PN532_SFR_FITEN = 0xFFA1,
    PN532_SFR_FDATA = 0xFFA2,
    PN532_SFR_FSIZE = 0xFFA3,
    PN532_SFR_IEO = 0xFFA8,
    PN532_SFR_SPI_CTRL = 0xFFA9,
    PN532_SFR_SPI_STAT = 0xFFAA,
    PN532_SFR_HSU_STA = 0xFFAB,
    PN532_SFR_HSU_CTR = 0xFFAC,
    PN532_SFR_HSU_PRE = 0xFFAD,
    PN532_SFR_HSU_CNT = 0xFFAE,
    PN532_SFR_P3 = 0xFFB0,
    PN532_SFR_IP0 = 0xFFB8,
    PN532_SFR_CIU_COMMAND = 0xFFD1,
    PN532_SFR_IEN1 = 0xFFE8,
    PN532_SFR_P7CFGA = 0xFFF4,
    PN532_SFR_P7CFGB = 0xFFF5,
    PN532_SFR_P7 = 0xFFF7,
    PN532_SFR_IP1 = 0xFFF8,
    PN532_SFR_P3CFGA = 0xFFFC,
    PN532_SFR_P3CFGB = 0xFFFD,
} PN532_SFR;
typedef enum
{
    PN532_XRAM_INVALID = -1, // FIXME: If needed
} PN532_XRAM;
...
// RFConfiguration
#define PN532_RFConfiguration_BUFF_SIZE 1 + 11 // CfgItem type, largest CfgItem data
typedef enum
{
    PN532_RFConfiguration_CfgItem_RFField = 0x01,
    PN532_RFConfiguration_CfgItem_VariousTimings = 0x02,
    PN532_RFConfiguration_CfgItem_MaxRtyCOM = 0x04,
    PN532_RFConfiguration_CfgItem_MaxRetries = 0x05,
    PN532_RFConfiguration_CfgItem_AnalogSettings_106k_typeA = 0x0a,
    PN532_RFConfiguration_CfgItem_AnalogSettings_212k_424k = 0x0b,
    PN532_RFConfiguration_CfgItem_AnalogSettings_typeB = 0x0c,
    PN532_RFConfiguration_CfgItem_AnalogSettings_212k_424k_848k_iso4443dash4 = 0x0d,
} PN532_RFConfiguration_CfgItem;
// RFRegulationTest
